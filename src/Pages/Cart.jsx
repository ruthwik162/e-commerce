...
const Cart = () => {
    ...
    const { products, currency, cartItems, removeFromCart, navigate, getCartItem, getcartCount, updateCartItems, getCartAmount } = useAppContext();
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <select onChange={(e) => updateCartItems(product._id, Number(e.target.value))} value={cartItems[product._id]} className='outline-none'>
                                            {Array.from({ length: Math.max(9, cartItems[product._id] || 1) }).map((_, index) => (
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 rounded-2xl max-md:mt-16 border border-gray-300/70">
                ...
                <button className="w-full py-3 rounded-md mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primary-dull transition">
