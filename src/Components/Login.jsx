...
const Login = () => {
  ...
  return (
    <div onClick={()=>{setShowUserLogin(false)}} className='fixed top-0 bottom-0 left-0 right-0  flex items-center text-sm text-gray-600 z-[50] bg-black/50'>
